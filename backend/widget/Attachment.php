...
class Attachment extends UploadFile{
	...
	public function run($value='')
	{
		...
		$this->getView()->registerJs('url="'.Yii::$app->urlManager->createAbsoluteUrl(['attachment/create-by-ajax', 'field' => $this->field, 'modelPk' => $this->model->primaryKey, 'hash' => $this->hash ]).'"');
		parent::run();
