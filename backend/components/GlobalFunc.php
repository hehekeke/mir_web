...
class GlobalFunc{
	...
	*/
	 ...
	 */
	 ...
	 {	
	 	return preg_match('/^1{1}\d{10}$/', $phone);
	 }
	  ...
	  * @return [type]           [description]
	  */
	 public static function dayOfTimeWith($dateTime) 
	 {
	 	return strtotime(date("Y-m-d", strtotime($dateTime)));
	 }

	 /**
	  * 阿拉伯数字转语文数字 目前只支持10以内
	  * @param  [type] $number [description]
	  * @return [type]         [description]
	  */
	 public static function numberToChina($number) {
	 	$chinaFigures = ['一','二', '三', '四', '五','六', '七','八','九','十'];
	 	return $chinaFigures[$number-1];
	 }
}
?>
