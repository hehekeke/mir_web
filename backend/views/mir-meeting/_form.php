                    ...
                    <div class="row">
                        <?php $form = ActiveForm::begin(); ?>
                            <div class="col-lg-6">
                                ...
                                <?= $form->field($model, 'meeting_edate')->widget(DateTimePicker::className(), [
                                    'language' => 'zh-CN',
                                    'size' => 'ms',
                                    'template' => '{input}',
                                    'pickButtonIcon' => 'glyphicon glyphicon-time',
                            ...
                            <div class="col-xs-10">
                                <div class="form-group" style="">
                                    <label>文章内容</label>
                                    <textarea id="editor" style="height:350px;background-color:#ccc;" name="<?=$model->formName()?>[meeting_mem]" ><?=$model->meeting_mem?></textarea>
                                    <?= Ueditor::widget(['obj'=>'editor'])?>
                                </div>
                                <div class="form-group" style="">
                                    <label>文章内容英文</label>
                                    <textarea id="editor_e" style="height:350px;background-color:#ccc;" name="<?=$model->formName()?>[meeting_mem_e]" ><?=$model->meeting_mem_e?></textarea>
